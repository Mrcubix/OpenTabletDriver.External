...
public class DoublePropertyDataTemplate : IDataTemplate
{
    ...
    [Content]
    public Dictionary<bool, IDataTemplate> PropertyTemplates { get; } = [];
    ...
    public Control? Build(object? param)
    {
        ...
        if (PropertyTemplates.TryGetValue(pair.Property is SerializableSliderProperty, out var template))
